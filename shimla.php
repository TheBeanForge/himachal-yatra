...
<head>
  ...
  <title>Shimla Trips &amp; Cab Booking | Himachal Safar</title>
  <meta name="description" content="Book Shimla cab from Delhi. Mall Road, Jakhu Temple, Kufri, Chail — experience the Queen of Hills with Himachal Safar.">
  <?php
    $seoTitle = 'Shimla Trips & Cab Booking | Himachal Safar';
...
<main>
  ...
  <section class="dest-hero" id="home">
    <div class="dest-hero-bg">
      <img src="<?= h(dest_img_src($hero_photo, $activeDest)) ?>" alt="Shimla Queen of Hills Himachal Pradesh" fetchpriority="high" decoding="async" width="1920" height="1080">
    </div>
    ...
    <div class="container mx-auto px-3 dest-hero-content">
      ...
      <a href="index.php?calc=shimla" class="dest-hero-btn"><i class="fa-solid fa-calculator"></i> Plan Shimla Trip</a>
    </div>
  </section>
    ...
    <div class="container mx-auto px-3">
      <div class="dest-about-grid">
        ...
        <div class="dest-about-img reveal">
          <img src="<?= h(dest_img_src($about_photo, $activeDest)) ?>" alt="Shimla hills Himachal Pradesh" loading="lazy" decoding="async" width="800" height="600">
        </div>
      </div>
    </div>
  </section>
      ...
      <div class="dest-gallery-grid reveal">
        <?php if (!empty($db_photos)): ?>
          ...
          <div class="gallery-item<?= $i === 0 || $i === 4 ? ' gi-wide' : '' ?>">
            <img src="uploads/photos/<?= h($p['filename']) ?>" alt="<?= h($p['caption'] ?: 'Shimla') ?>" loading="lazy">
          </div>
          <?php endforeach; ?>
        <?php else: ?>
      ...
      <div class="dest-route-cards">
        <div class="dest-route-card reveal">
          ...
          <div class="drc-meta">
            ...
            <span class="drc-badge">Weekend Itinerary</span>
          </div>
          <div class="drc-bottom">
            
            <a href="index.php?calc=shimla" class="drc-btn">Plan My Trip <i class="fa-solid fa-arrow-right"></i></a>
          </div>
        </div>
        <div class="dest-route-card reveal">
          <div class="drc-top">
          ...
          <div class="drc-meta">
            ...
            <span class="drc-badge">Express Itinerary</span>
          </div>
          <div class="drc-bottom">
    ...
    <div class="container mx-auto px-3">
      <div class="dest-cta-inner reveal">
        <div class="dest-cta-text">
          ...
          <p>Share your dates and pickup city. We will suggest the right vehicle, timing and quote for a private Shimla journey.</p>
        </div>
        <div class="dest-cta-btns">
          <a href="index.php?calc=shimla" class="btn orange-btn"><i class="fa-solid fa-calculator"></i> Plan My Trip</a>
          <a href="https://wa.me/<?php echo h($whatsappNumber); ?>?text=<?php echo rawurlencode('Hi, I want a private Shimla trip quote. Please help me plan the route.'); ?>" target="_blank" rel="noopener" class="btn wa-cta-btn"><i class="fa-brands fa-whatsapp"></i> WhatsApp Concierge</a>
        </div>
      </div>
    </div>
  </section>
