...
<head>
  ...
  <?php
    $seoTitle = 'Shimla Tour Packages & Cab Booking | Himachal Yatra Travels';
    $seoDesc  = 'Book Shimla cab from Delhi. Mall Road, Jakhu Temple, Kufri, Chail — experience the Queen of Hills with Himachal Yatra Travels.';
    $seoPath  = 'shimla.php';
