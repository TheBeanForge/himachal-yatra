...
<main>
  ...
  <section class="dest-hero">
    ...
    <div class="container mx-auto px-3 dest-hero-content">
      ...
      <a href="index.php#contact" class="dest-hero-btn"><i class="fa-brands fa-whatsapp"></i> Plan Shimla Trip</a>
    </div>
  </section>
    ...
    <div class="container mx-auto px-3">
      <div class="dest-about-grid">
        ...
        <div class="dest-about-img reveal">
          <?php $aboutImg = !empty($db_photos[1]) ? 'uploads/photos/' . h($db_photos[1]['filename']) : (!empty($db_photos[0]) ? 'uploads/photos/' . h($db_photos[0]['filename']) : 'https://images.unsplash.com/photo-1597074866923-dc0589150358?auto=format&fit=crop&w=800&q=85'); ?>
          <img src="<?= $aboutImg ?>" alt="Shimla hills Himachal Pradesh" loading="lazy" decoding="async" width="800" height="600">
        </div>
      </div>
    </div>
  </section>
