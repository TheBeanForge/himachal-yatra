...
<head>
  ...
  <?php
    $seoTitle = 'Dalhousie Tour Packages & Cab Booking | Himachal Yatra Travels';
    $seoDesc  = 'Book Delhi to Dalhousie. Khajjiar (mini Switzerland), Dainkund Peak, Chamera Lake — peaceful hill station with Himachal Yatra Travels.';
...
<main>
  ...
  <section class="dest-hero">
    ...
    <div class="container mx-auto px-3 dest-hero-content">
      ...
      <a href="index.php?calc=dalhousie" class="dest-hero-btn"><i class="fa-solid fa-calculator"></i> Plan Dalhousie Trip</a>
    </div>
  </section>
      ...
      <div class="dest-route-cards">
        <div class="dest-route-card reveal">
          ...
          <div class="drc-bottom">
            ...
            <a href="index.php?calc=dalhousie" class="drc-btn">Plan My Trip <i class="fa-solid fa-arrow-right"></i></a>
          </div>
        </div>
        <div class="dest-route-card reveal">
          <div class="drc-top">
    ...
    <div class="container mx-auto px-3">
      <div class="dest-cta-inner reveal">
        ...
        <div class="dest-cta-btns">
          <a href="index.php?calc=dalhousie" class="btn orange-btn"><i class="fa-solid fa-calculator"></i> Plan My Trip</a>
