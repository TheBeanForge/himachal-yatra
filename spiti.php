...
<main>
  ...
  <section class="dest-hero">
    <div class="dest-hero-bg">
      <?php $heroImg = !empty($db_photos[0]) ? 'uploads/photos/' . h($db_photos[0]['filename']) : 'https://images.unsplash.com/photo-1504457047772-27faf1c00561?auto=format&fit=crop&w=1920&q=90'; ?>
      <img src="<?= $heroImg ?>" alt="Spiti Valley high altitude Himachal Pradesh" fetchpriority="high" decoding="async" width="1920" height="1080">
    </div>
    ...
    <div class="container mx-auto px-3">
      <div class="dest-about-grid">
        ...
        <div class="dest-about-img reveal">
          ...
          <img src="<?= $aboutImg ?>" alt="Spiti Valley high altitude landscape" loading="lazy" decoding="async" width="800" height="600">
        </div>
      </div>
    </div>
  </section>
