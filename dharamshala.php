...
<head>
  ...
  <title>Dharamshala &amp; McLeodganj Tour | Himachal Yatra Travels</title>
  <meta name="description" content="Book Delhi to Dharamshala cab from ₹8,999. McLeodganj, Triund Trek, Bhagsu Waterfall, Dalai Lama Temple — expert Kangra Valley travel with Himachal Yatra Travels.">
...
<main>
  ...
  <section class="dest-hero">
    <div class="dest-hero-bg">
      <img src="https://images.unsplash.com/photo-1470770841072-f978cf4d019e?auto=format&fit=crop&w=1920&q=90" alt="Dharamshala McLeodganj Himachal Pradesh" fetchpriority="high" decoding="async" width="1920" height="1080">
    </div>
    ...
    <div class="container mx-auto px-3 dest-hero-content">
      ...
      <a href="index.php#contact" class="dest-hero-btn"><i class="fa-brands fa-whatsapp"></i> Book Dharamshala Trip</a>
    </div>
  </section>
      ...
      <div class="dest-route-cards">
        <div class="dest-route-card reveal">
          ...
          <div class="drc-bottom">
            <div class="drc-price">Starting ₹8,999</div>
        ...
        <div class="dest-route-card reveal">
          ...
          <div class="drc-bottom">
            <div class="drc-price">Starting ₹5,499</div>
            <a href="index.php#contact" class="drc-btn">Book Now <i class="fa-solid fa-arrow-right"></i></a>
          </div>
        </div>
        <div class="dest-route-card reveal">
          ...
          <div class="drc-bottom">
            <div class="drc-price">Starting ₹2,499</div>
            <a href="index.php#contact" class="drc-btn">Book Now <i class="fa-solid fa-arrow-right"></i></a>
          </div>
        </div>
      </div>
    ...
    <div class="container mx-auto px-3">
      <div class="dest-cta-inner reveal">
        <div class="dest-cta-text">
          ...
          <p>Get a free quote on WhatsApp in minutes. Expert Kangra Valley drivers ready to take you there.</p>
        </div>
        <div class="dest-cta-btns">
          <a href="index.php#contact" class="btn orange-btn"><i class="fa-solid fa-calendar-check"></i> Book Now</a>
          <a href="https://wa.me/<?php echo h($whatsappNumber); ?>?text=<?php echo rawurlencode('Hi, I want to book a trip to Dharamshala/McLeodganj. Please share a quote.'); ?>" target="_blank" rel="noopener" class="btn wa-cta-btn"><i class="fa-brands fa-whatsapp"></i> WhatsApp Us</a>
        </div>
      </div>
    </div>
  </section>
